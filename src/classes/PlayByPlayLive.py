...
class PlayByPlayLive:
    def __init__(self, game_id: str, action: Dict[str, Any]):
        ...
        self.off_team_id = action.get("possession")
        ...
        # self.home_possession = int(self.team_id == self.off_team_id) if self.team_id and self.off_team_id else None
